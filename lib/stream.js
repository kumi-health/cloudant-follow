...
Changes.prototype.write = function(data, encoding) {
  ...
  if (self.feed === 'longpoll') { return self.write_longpoll(data); } else if (self.feed === 'continuous') { return self.write_continuous(data); }
};
...
Changes.prototype.normalize_data = function(data, encoding) {
  ...
  if (self.feed !== 'continuous' && self.feed !== 'longpoll') { return self.error(new Error('Must set .feed to "continuous" or "longpoll" before writing data')); }
